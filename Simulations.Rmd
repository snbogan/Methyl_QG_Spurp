...
1. Perform statistical test for differences in VA, h2, etc.
2. Estimate indirect effects of M on GE via mediation
3. Measure and plot phenome wide distributions of VA and h2 by heritability
4. Look into 'family means' animal model
5. Simulate 100 independent traits
6. Add gaussian process for genetic correlation to model
