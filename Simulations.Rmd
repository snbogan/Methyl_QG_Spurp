...
Potential solution: hierarchical model predicting covariance between genetic and methylation effects?
...
f1b <- bf(GE ~ 1 + (1 + M | gr(ID, cov = relat_m)) + # Fits relatedness matrix w/ meth partitions for GE
       F0_env + F1_env + (1 | Dam) + (1 | Sire) + M) # Environ. + dam/sire effects on GE
